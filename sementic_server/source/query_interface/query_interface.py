...
class QueryInterface(object):
    ...
    def init_targets(self):
        ...
        for tid, iid in enumerate(intent_node_ids):
            target = Target(target_id=tid, intent_node_id=iid, intent_node_ids=intent_node_ids,
                            links=self.links, graph=self.graph)
